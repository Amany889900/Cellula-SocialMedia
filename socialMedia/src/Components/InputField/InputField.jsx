...
function InputField({ type,name,id,placeholder,label,value,...rest }) {
  return (
    <div className="relative z-0 w-full mb-5 group">
      <input type={type} name={name} value={value?value:null} id={id} className="focus:placeholder-transparent block py-5 px-5 w-full text-sm text-gray-900 bg-transparent rounded-2xl border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#34D15C] focus:outline-none focus:ring-0 focus:border-[#34D15C] peer" placeholder={placeholder} {...rest}/>
