...
function Settings() {
    const listItems = [
        <div className="flex items-center mb-10">
          ...
          <div className="ms-auto w-[36px] h-[36px] rounded-full border-2 border-[#EEEEEE] flex justify-center items-center"><i class="fa-solid fa-chevron-right text-[#919191]"></i></div>
       </div>
            ,
               <div className="flex items-center mb-10">
          <div>
